...
const ayush = {
  ...
  education: "B.Tech CSE — IMS Engineering College (AKTU) 2022-2026",
  
  experience: [
    "SDE Intern @ IIT Ropar (Android Dev - Kotlin & Jetpack Compose)",
  ...
  achievements: [
    "📱 Reduced Android app crash rate by 30% @ IIT Ropar",
    "📊 Processed 100K+ records with 95%+ SQL accuracy",
    "🎯 Built KPI dashboards reducing reporting errors by 35%",
    "🏆 Event Management Head — Data Handler Club"
  ],
  
  funFact: "I turn raw data into insights and ideas into apps! 🚀"
};
